...
public class JunctionBasedOnHubPipeline extends OpenCvPipeline {
    ...
    public static Scalar lower = new Scalar(0, 126, 80);
    ...
    private final double optimalEccentricity = 9;
    ...
    public Mat processFrame(Mat input) {
        ...
        cleanMask(processedMat, processedMat);
        processedMat.copyTo(thresholdedMat);
        // Find contours
        vUtil.getContours(processedMat, contours);
        vUtil.getFilteredContours(contours, 50, 2000);
        // Draw contours
